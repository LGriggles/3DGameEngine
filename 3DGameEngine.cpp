...
GraphicsRenderer _mainRenderer;						//Handles drawing SFM
HWND hWnd;
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		_mainRenderer.winAPIinput(wmId);
		switch (wmId)
		{
		case IDM_ABOUT:
...
void WinAPIinterface::spawnContextMenu(sf::Vector2i position)
{
	...
	TrackPopupMenu((HMENU) GetSubMenu(LoadMenu(hInst, MAKEINTRESOURCE(IDR_MENU1)), 0), TPM_LEFTBUTTON, cursorPosition.x, cursorPosition.y, 0, hWnd, NULL);
}

namespace WindowsAPIinterface
{
	WinAPIinterface winAPIinterface;
}
